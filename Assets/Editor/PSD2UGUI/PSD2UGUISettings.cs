...
namespace DGame.PSD2UGUI
{
    ...
    public class PSD2UGUISettings : ScriptableObject
    {
        ...
        public string defaultTmpFontAssetPath = "Assets/TextMesh Pro/Resources/Fonts & Materials/LiberationSans SDF.asset";
        ...
        [MenuItem("Tools/UISettings/Open PSD2UGUI Settings")]
